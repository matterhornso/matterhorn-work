...
export const BITTENSOR_OPERATOR_WORKFLOW: MatterhornWorkflowManifest = {
  ...
  description:
    "Guides a Bittensor operator through public SS58 context, balance/readiness checks, subnet discovery, validator comparison, and reviewed TAO transfer, stake, and unstake calls. The connected wallet approves every supported transaction; unsupported advanced calls stay unavailable.",
  status: "live_local",
  inputPrompts: [
    {
      id: "wallet_address",
  ...
  steps: [
    ...
    },
    {
      ...
      name: "Review stake",
      description: "Build an exact stake/delegation review. The connected wallet signs and submits only after user approval.",
      serviceHook: "bittensor",
...
export const HYPERLIQUID_PREVIEW_WORKFLOW: MatterhornWorkflowManifest = {
  ...
  name: "Hyperliquid Research / Trade Review",
  category: "markets",
  targetUserPersona: "Hyperliquid trader or watcher",
  description:
    "Read Hyperliquid market and account context, research the opportunity, and prepare an unsigned preview. The agent workflow cannot place orders; manual execution is a separate trade-ticket flow that requires exact-order review, a short-lived server intent, connected-wallet approval, and an enabled deployment gate.",
  status: "preview_only",
  inputPrompts: [
    {
      id: "market_id",
  ...
  generatedArtifacts: [
    ...
    {
      id: "external_handoff",
      name: "Manual Trade Ticket Handoff",
      mimeType: "application/json",
      public: true,
      generatedByStep: "stage_5_external_handoff",
      description:
        "Redacted handoff for the separate trade ticket. It is not signed or submittable by the agent workflow.",
    },
    {
      id: "handoff_confirmation",
      name: "Trade Review Handoff Confirmation",
      mimeType: "text/markdown",
      public: true,
      generatedByStep: "stage_6_handoff_confirmation",
      description:
        "Summary of what was prepared and the explicit user steps required in the separate trade ticket.",
    },
  ],
  steps: [
    {
    ...
    },
    {
      ...
      description:
        "Prepare an unsigned trade preview. Agents, chats, MCP tools, watches, and automations never sign or submit orders.",
    ...
    },
    {
      ...
      name: "Manual trade ticket handoff",
      description:
        "Build a redacted handoff for the separate trade ticket. Only that user-controlled surface may request an exact, short-lived execution intent.",
      inputPromptIds: ["market_id", "side", "size", "wallet_address"],
    ...
    },
    {
      ...
      description:
        "Confirm what was prepared. Explain that any submission requires exact-order review, connected-wallet approval, an unexpired one-time intent, and an enabled deployment gate in the separate trade ticket.",
      inputPromptIds: ["market_id"],
  ...
  qaContract: {
    checklist: [
      "Market data and agent workflows remain read/preview only",
      "No API secrets or private keys are requested",
      "Unsigned agent previews never become signed or submittable agent payloads",
      "Only the separate manual trade ticket may request a short-lived execution intent",
      "The trade ticket requires exact-order review and connected-wallet approval before one-time submission",
    ],
    requiredTests: [
      "scripts/market-execution-safety-gate.test.mjs",
      "scripts/market-execution-chain-gate.test.mjs",
    ],
    successCriteria: [
      "Workflow status is preview_only",
      "All service hooks are preview_only",
      "Agent workflow safety has canSubmit: false and liveExecutionEnabled: false",
      "Manual execution remains isolated behind the separate wallet-approved trade ticket",
    ],
    owner: "kimi",
  },
};
...
export const HYPERLIQUID_TRADER_CUSTOMER_TEMPLATE: MatterhornCustomerWorkflowTemplate = {
  ...
  summary:
    "Read Hyperliquid markets, check exposure, and prepare perpetual order previews.",
  promise:
    "Research and preview only. Finish real orders in your own reviewed Hyperliquid client.",
  category: "markets",
  examplePrompts: [
  ...
  handoffReceiptSupport: {
    ...
    description:
      "Produces a market preview and external-client handoff without signing or submission.",
  },
  serviceHooks: [{ hook: "hyperliquid", status: "preview_only" }],
  chatMode: "crypto chat",
  launch: {
  ...
  ui: {
    ...
    accent: "matterhorn_blue",
    shortDescription:
      "Research markets, review exposure, and prepare an external handoff.",
  },
  routing: {
...
export const BITTENSOR_PROTOCOL_WORKSPACE_MANIFEST: MatterhornProtocolWorkspaceManifest = {
  ...
  allowedIntents: [
    ...
    "compare subnets",
    "compare validators",
    "prepare TAO transfer",
    "review and submit TAO transfer",
    "preview stake",
    "prepare handoff",
  ],
  safetyBoundaries: {
...
export const HYPERLIQUID_PROTOCOL_WORKSPACE_MANIFEST: MatterhornProtocolWorkspaceManifest = {
  ...
  allowedIntents: [
    ...
    "preview trade",
    "review and submit manual order",
    "show exposure",
    "manage watch",
  ],
  safetyBoundaries: {
  ...
  demoPrompt: "Preview a Hyperliquid BTC-PERP order",
  launchBehavior: "opens_desk",
};
...
export const POLYMARKET_PROTOCOL_WORKSPACE_MANIFEST: MatterhornProtocolWorkspaceManifest = {
  ...
  allowedIntents: [
    "research market",
    "preview trade",
    "prepare eligible buy order",
    "prepare eligible sell order",
    "cancel exact orders",
    "review and submit eligible order",
    "show positions",
    "prepare handoff",
  ],
  safetyBoundaries: {
...
export const BITTENSOR_TAO_STAKING_PREVIEW_DEMO_SCENARIO: CustomerBetaDemoScenario = {
  ...
  targetCustomerPersona: "TAO operator or delegator reviewing an exact wallet-approved staking action",
  assignedBetaCustomers: ["Alpha Node DAO", "TensorVault Labs"],
  entryPrompt: "Show my TAO, compare validators on subnet 1, and prepare a reviewed 1 TAO staking action",
  expectedArtifacts: [
    {
      id: "balance_card",
      name: "TAO Balance Card",
    ...
    },
    {
      ...
      mimeType: "application/json",
      public: true,
      description: "Exact stake review with estimated returns and connected-wallet approval.",
    },
    {
      id: "external_signer_handoff",
      name: "Wallet Review Handoff",
  ...
  passFailCriteria: {
    pass: [
      ...
      "Stake review shows exact public terms before wallet approval",
      "Connected-wallet review contains no private signing material",
    ],
    fail: [
      "Requests a private key or seed phrase",
      "Signs or submits without explicit connected-wallet approval",
      "Claims the agent can move TAO autonomously",
    ],
  },
...
export const BITTENSOR_DESK_MANIFEST: MatterhornDeskManifest = {
  ...
  deskShortName: "TAO",
  deskDescription: "Read Bittensor data and review TAO transfer, stake, and unstake calls in a connected wallet.",
  deskAccent: "purple",
  customerPrimaryAction: "Review a TAO transfer, stake, or unstake call",
  customerSafetyStrip: "Every supported transaction requires connected-wallet approval. Unsupported advanced calls stay unavailable. Never provide private keys or seed phrases.",
  status: "beta_ready",
...
export const HYPERLIQUID_DESK_MANIFEST: MatterhornDeskManifest = {
  ...
  deskShortName: "HL",
  deskDescription: "Read Hyperliquid markets and exposure, then review and submit exact orders with a connected wallet.",
  deskAccent: "green",
  customerPrimaryAction: "Review and submit an exact order",
  customerSafetyStrip: "The agent prepares the order. Submission occurs only after you review the exact terms and approve a short-lived intent in your connected wallet.",
  status: "beta_ready",
...
export const POLYMARKET_DESK_MANIFEST: MatterhornDeskManifest = {
  ...
  deskShortName: "PM",
  deskDescription: "Research Polymarket markets, check eligibility, and authorize supported buy, sell, and cancel actions with a connected Polygon wallet.",
  deskAccent: "orange",
  customerPrimaryAction: "Research a market or review an eligible order",
  customerSafetyStrip: "Eligible EOA buy, sell, and cancel actions require compliance approval, exact review, and connected-wallet authorization. Unsupported flows stay unavailable.",
  status: "beta_ready",
  allowedSurfaces: ["protocol_desk", "workflow_chat"],
  liveSubmissionEnabled: false,
  acceptsPrivateKeys: false,
...
export const SUI_DESK_MANIFEST: MatterhornDeskManifest = {
  ...
  deskDisplayName: "Sui",
  deskShortName: "Sui",
  deskDescription: "Read Sui accounts and review, sign, and submit transfers in a connected Sui wallet.",
  deskAccent: "matterhorn_blue",
  customerPrimaryAction: "Read a wallet or review a transfer",
  customerSafetyStrip: "The agent prepares the transfer. Your connected Sui wallet shows the exact transaction before you sign and submit it.",
  status: "beta_ready",
  allowedSurfaces: ["protocol_desk", "workflow_chat", "evidence_packet"],
  liveSubmissionEnabled: false,
  acceptsPrivateKeys: false,
...
export const BITTENSOR_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  id: "bittensor",
  displayName: "Bittensor",
  shortDescription: "TAO reads, subnet research, and reviewed transfer, stake, and unstake calls.",
  launcherTitle: "Bittensor",
  launcherDescription: "Read TAO and subnet context, then review transfer, stake, or unstake calls.",
  launcherPrompt: "Show my TAO or compare validators on subnet 1",
  rightRailSummary: "Review transfer, stake, and unstake calls in a connected Bittensor wallet. Unsupported advanced calls stay unavailable.",
  ...
  capabilityBullets: [
    ...
    "Review TAO transfers with a connected Bittensor wallet",
    "Review stake and unstake calls with a connected Bittensor wallet",
    "Watch subnets and import public receipts",
  ],
  safetySummary: "Transfer, stake, and unstake calls require exact review and connected-wallet approval. Unsupported advanced calls stay unavailable.",
  customerCapabilitySummary: "Read TAO balances, stake allocations, subnet data, and validator comparisons. Review transfer, stake, and unstake calls in a connected wallet.",
  noCustodySafetyLine: "Matterhorn never holds your coldkey, hotkey, or seed phrase. Every transaction is approved in your wallet.",
  ...
  emptyStateCopy: {
    ...
    body: "Paste a public SS58 address or connect a Bittensor wallet to review transfer, stake, and unstake calls. Private keys and seed phrases are never accepted.",
...
export const HYPERLIQUID_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  id: "hyperliquid",
  displayName: "Hyperliquid",
  shortDescription: "Perpetual market research, exposure checks, and wallet-approved orders.",
  launcherTitle: "Hyperliquid",
  launcherDescription: "Research perp markets, manage watches, and review exact orders before wallet approval.",
  launcherPrompt: "Review a Hyperliquid BTC-PERP order",
  rightRailSummary: "Review the exact order in a separate trade ticket before your connected wallet approves it.",
  ...
  statusBadgeLabel: "Manual wallet approval",
  ...
  primaryActions: [
    {
      actionId: "preview-order",
      label: "Review order",
      iconHint: "preview",
      intent: "review and submit manual order",
      requiresConfirmation: true,
      surface: "desk_panel",
    },
    {
  ...
  capabilityBullets: [
    ...
    "Review the exact market or limit order before approval",
    "Submit once after approval from your connected wallet",
    "Manage market watches and receipts",
  ],
  safetySummary: "Only the exact reviewed order can be submitted after approval from your connected wallet. Agents and watches cannot submit.",
  customerCapabilitySummary: "Read perp markets, funding, exposure, and open orders, then review an exact order in the manual trade ticket.",
  noCustodySafetyLine: "Matterhorn submits only the exact reviewed order after one-time connected-wallet approval.",
  suggestedPromptTitles: [
  ...
  emptyStateCopy: {
    headline: "Connect Hyperliquid",
    body: "Connect your wallet to inspect exposure and review an exact order before approval.",
    primaryActionId: "preview-order",
  },
  degradedStateCopy: {
    headline: "Hyperliquid is temporarily unavailable",
    body: "Market data or the manual trade ticket could not be reached. No order was submitted.",
...
export const POLYMARKET_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  id: "polymarket",
  displayName: "Polymarket",
  shortDescription: "Prediction market research, compliance checks, and wallet-approved buy, sell, and cancel actions.",
  launcherTitle: "Polymarket",
  launcherDescription: "Research prediction markets, check eligibility, and review exact orders.",
  launcherPrompt: "Find Polymarket markets about AI",
  rightRailSummary: "Research markets and review eligible buy, sell, and cancel actions before connected Polygon-wallet approval.",
  ...
  actionStatus: "live",
  extensionStatus: "built_in_live",
  statusBadgeLabel: "Wallet approval",
  statusBadgeTone: "success",
  ...
  capabilityBullets: [
    ...
    "Review eligible EOA buy, sell, and cancel actions before wallet approval",
    "Manage market watches and receipts",
  ],
  safetySummary: "Eligible EOA buy, sell, and cancel actions require compliance approval, exact review, and connected Polygon-wallet authorization. Unsupported account types stay unavailable.",
  customerCapabilitySummary: "Research prediction markets, view probabilities and orderbooks, check compliance, and review eligible EOA buy, sell, and cancel actions.",
  noCustodySafetyLine: "Matterhorn never holds your credentials. Every supported action is authorized in your connected Polygon wallet.",
  suggestedPromptTitles: [
  ...
  emptyStateCopy: {
    ...
    body: "Search markets, check compliance, or prepare an eligible buy, sell, or cancel action for connected-wallet review.",
...
export const SUI_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  primaryActions: [
    ...
    },
    {
      ...
      iconHint: "preview",
      intent: "review and submit transfer",
      requiresConfirmation: true,
      surface: "desk_panel",
    },
  ],
  primaryActionLabel: "Review transfer",
  secondaryActions: [
    {
  ...
  degradedStateCopy: {
    headline: "Sui wallet unavailable",
    body: "Sui provider data or the connected wallet is temporarily unreachable. Saved drafts and public receipts remain in Project history.",
...
export const MCPS_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  shortDescription: "View managed Model Context Protocol tools, connection health, and access boundaries.",
  launcherTitle: "MCP Tools",
  launcherDescription: "Use Matterhorn-managed tools on web; configure custom MCPs in Matterhorn Desktop.",
  launcherPrompt: "Show my managed MCP tools and connection health",
  rightRailSummary: "Managed tools are available on web. Custom MCP installation and configuration stay in Matterhorn Desktop.",
  ...
  primaryActions: [
    {
      actionId: "view-managed-tools",
      label: "View managed tools",
      iconHint: "tools",
      intent: "view managed tools and connection health",
      requiresConfirmation: false,
      surface: "desk_panel",
    },
  ],
  primaryActionLabel: "View managed tools",
  secondaryActions: [
    {
      actionId: "open-desktop-setup",
      label: "Open desktop setup guide",
      iconHint: "shield",
      intent: "show custom MCP setup guidance for Matterhorn Desktop",
      requiresConfirmation: false,
      surface: "context_menu",
    },
  ],
  ...
  customerVisible: true,
  capabilityBullets: [
    "View managed tools and connection health",
    "Use approved desk and workspace tools",
    "Review tool access and safety boundaries",
    "Configure custom MCPs in Matterhorn Desktop",
  ],
  safetySummary: "Managed tools follow workspace access boundaries. Matterhorn does not grant tools keys, signing ability, or access to secrets.",
  customerCapabilitySummary: "View managed tools and connection health on web. Configure custom MCPs in Matterhorn Desktop; no custody or hidden signing.",
  noCustodySafetyLine: "MCP tools cannot hold keys or sign on your behalf. Reviewed wallet actions always continue through a separate approval surface.",
  suggestedPromptTitles: [
    "Show my managed tools",
    "Check MCP connection health",
    "Which tools can this desk use?",
    "Configure a custom MCP in Desktop",
  ],
  emptyStateCopy: {
    headline: "No managed tools connected",
    body: "Managed Matterhorn tools appear automatically when the workspace backend is ready. Custom MCP setup is available in Matterhorn Desktop.",
    primaryActionId: "view-managed-tools",
  },
  degradedStateCopy: {
    headline: "MCP status unavailable",
    body: "Matterhorn could not refresh managed tool health. Existing configured tools have not been removed; retry when the workspace reconnects.",
    primaryActionId: "view-managed-tools",
  },
};
...
export const BITTENSOR_BRAND_ASSET_MANIFEST: ProtocolBrandAssetManifest = {
  ...
  allowedUseNote: "Use only in Matterhorn Desks UI surfaces. Do not modify colors or distort proportions.",
...
export const SUI_BRAND_ASSET_MANIFEST: ProtocolBrandAssetManifest = {
  ...
  allowedUseNote: "Use only in Matterhorn Desks UI surfaces. Do not imply custody, wallet ownership, or official Sui endorsement.",
...
export const BITTENSOR_MCP_CATALOG_ITEM: MatterhornMcpCatalogItem = {
  ...
  deskId: "bittensor",
  description:
    "Read Bittensor subnet, stake, and balance data. Prepare transfer, stake, and unstake calls for separate connected-wallet review. Unsupported advanced calls stay unavailable.",
