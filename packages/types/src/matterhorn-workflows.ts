...
export const HYPERLIQUID_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  id: "hyperliquid",
  displayName: "Hyperliquid",
  shortDescription: "Perpetual market research, exposure checks, and order previews.",
  launcherTitle: "Hyperliquid",
  launcherDescription: "Research perp markets, manage watches, and prepare order previews.",
  launcherPrompt: "Preview a Hyperliquid BTC-PERP order",
  rightRailSummary: "Research markets and prepare an order handoff to finish in your own Hyperliquid client.",
  ...
  extensionStatus: "built_in_partial",
  statusBadgeLabel: "Read and preview",
  ...
  primaryActionLabel: "Prepare preview",
  secondaryActions: [
    {
  ...
  capabilityBullets: [
    ...
    "Prepare market and limit order previews",
    "Manage market watches and receipts",
  ],
  safetySummary: "Matterhorn does not submit orders. Finish any real order in your own reviewed Hyperliquid client.",
  customerCapabilitySummary: "Read perp markets, funding, account exposure, and open orders. Prepare market and limit order previews for external review.",
  noCustodySafetyLine: "Matterhorn never holds credentials or submits orders. You finish real orders outside the app.",
  suggestedPromptTitles: [
  ...
  emptyStateCopy: {
    headline: "Preview Hyperliquid",
    body: "Add a public wallet address to inspect exposure and prepare an order preview.",
