...
export const BITTENSOR_OPERATOR_WORKFLOW: MatterhornWorkflowManifest = {
  ...
  description:
    "Guides a Bittensor operator through public SS58 context, balance/readiness checks, subnet discovery, validator comparison, reviewed TAO transfers, unsigned stake previews, external-signer handoffs, and evidence receipts. Direct transfers continue through a connected Bittensor wallet; staking and advanced calls remain external handoffs.",
  status: "live_local",
  inputPrompts: [
    {
      id: "wallet_address",
...
export const POLYMARKET_PROTOCOL_WORKSPACE_MANIFEST: MatterhornProtocolWorkspaceManifest = {
  ...
  allowedIntents: [
    "research market",
    "preview trade",
    "prepare eligible EOA BUY order",
    "review and submit eligible EOA BUY order",
    "show positions",
    "prepare handoff",
  ],
  safetyBoundaries: {
...
export const BITTENSOR_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  id: "bittensor",
  displayName: "Bittensor",
  shortDescription: "TAO reads, subnet research, reviewed transfers, and external-signer staking previews.",
  launcherTitle: "Bittensor",
  launcherDescription: "Read TAO and subnet context, review transfers, and prepare staking handoffs.",
  launcherPrompt: "Show my TAO or compare validators on subnet 1",
  rightRailSummary: "Review TAO transfers in a connected Bittensor wallet. Staking and advanced calls remain external-signer handoffs.",
  ...
  capabilityBullets: [
    ...
    "Prepare stake, unstake, and delegation handoffs",
    "Watch subnets and import public receipts",
  ],
  safetySummary: "TAO transfers require exact review and connected-wallet approval. Staking and advanced calls require an external signer.",
  customerCapabilitySummary: "Read TAO balances, stake allocations, subnet data, and validator comparisons. Review TAO transfers in a connected wallet and prepare advanced handoffs.",
...
export const POLYMARKET_PROTOCOL_DESK_MANIFEST: ProtocolDeskManifest = {
  ...
  id: "polymarket",
  displayName: "Polymarket",
  shortDescription: "Prediction market research, compliance checks, and wallet-approved BUY orders.",
  launcherTitle: "Polymarket",
  launcherDescription: "Research prediction markets, check eligibility, and review exact BUY orders.",
  launcherPrompt: "Find Polymarket markets about AI",
  rightRailSummary: "Research markets and review eligible EOA BUY orders before connected Polygon-wallet approval.",
  ...
  capabilityBullets: [
    ...
    "Review eligible EOA BUY orders before wallet approval",
    "Manage market watches and receipts",
  ],
  safetySummary: "Eligible EOA BUY orders require compliance approval, exact review, and connected Polygon-wallet authorization. Other flows stay external.",
  customerCapabilitySummary: "Research prediction markets, view probabilities and orderbooks, check compliance, and review eligible EOA BUY orders.",
  noCustodySafetyLine: "Matterhorn never holds your credentials. Every eligible BUY order is authorized in your connected Polygon wallet.",
  suggestedPromptTitles: [
  ...
  emptyStateCopy: {
    ...
    body: "Search markets, check compliance, or prepare an eligible BUY order for connected-wallet review.",
...
export const BITTENSOR_MCP_CATALOG_ITEM: MatterhornMcpCatalogItem = {
  ...
  deskId: "bittensor",
  description:
    "Read Bittensor subnet, stake, and balance data. Prepare TAO transfers for separate connected-wallet review, and external-signer handoffs for stake, unstake, and advanced calls.",
