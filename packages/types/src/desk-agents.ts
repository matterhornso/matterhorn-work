...
export const MATTERHORN_DESK_AGENT_MANIFESTS: Record<MatterhornDeskAgentDeskId, MatterhornDeskAgentManifest> = {
  ...
  blank: {
    ...
    capabilityPolicy: {
      ...
      ...NEVER_AGENT_SUBMITS,
      evidence: "workspace",
      statusLabel: "Private workspace",
      summary: "Handles custom work with selected workspace context and routes protocol-specific requests to the appropriate desk.",
    },
    contextPolicy: {
      ...DEFAULT_CONTEXT_POLICY,
      includeWalletPublicContext: true,
    ...
    displayName: "Private AI Agent",
    description: "Flexible Matterhorn agent for private workflows, files, notes, and custom tasks.",
    instructions: [
      AGENT_SHARED_BOUNDARY,
      "",
      "Desk scope:",
      "- Handle research, writing, planning, analysis, files, and other custom work when no dedicated desk agent is a better fit.",
      "- Use only the files, notes, memory, and tools explicitly available in this workspace and request.",
