...
export const MATTERHORN_DESK_AGENT_MANIFESTS: Record<MatterhornDeskAgentDeskId, MatterhornDeskAgentManifest> = {
  bittensor: {
    ...
    toolPolicy: {
      ...
      work: ["matterhorn-work_matterhorn_bittensor_chat"],
      readOnly: [],
    },
    capabilityPolicy: {
      ...
      statusLabel: "Prepare only",
      summary: "Reads public Bittensor data and prepares unsigned actions for your external signer.",
    },
    contextPolicy: {
  ...
  polymarket: {
    ...
    capabilityPolicy: {
      ...
      evidence: "tool_and_receipt",
      statusLabel: "Prepare only",
      summary: "Researches live markets and prepares compliance-gated drafts for review in your Polymarket client.",
    },
    contextPolicy: {
      ...DEFAULT_CONTEXT_POLICY,
      includeCryptoSafetyPolicy: true,
