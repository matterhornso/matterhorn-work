...
For a containerized worker runtime, start from the [Docker packaging](https://github.com/matterhornso/matterhorn-work/tree/dev/packaging/docker) in the repo.
