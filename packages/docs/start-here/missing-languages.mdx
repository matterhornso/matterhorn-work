...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/matterhornso/matterhorn-work/tree/dev/apps/app/src/i18n/locales).
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/matterhornso/matterhorn-work/issues/1385).
