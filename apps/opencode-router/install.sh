...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/matterhornso/matterhorn-work.git}"
...
Environment variables:
  ...
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/matterhornso/matterhorn-work.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/matterhornso/matterhorn-work/dev/apps/opencode-router/install.sh | bash
EOF
}
