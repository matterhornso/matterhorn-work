      ...
      <section className="hero-card panel">
        <div className="hero-copy">
          ...
          <p>
            ...
            the gradients that `@matterhorn-work/ui/react` will render anywhere else in the repo.
          </p>
        </div>
      ...
      <section className="footer-grid">
        ...
        <div className="panel code-panel">
          ...
          <div className="pill-stack">
            <code className="import-pill">@matterhorn-work/ui/react</code>
            <code className="import-pill">@matterhorn-work/ui/solid</code>
          </div>
          <pre>{`import { PaperMeshGradient, PaperGrainGradient } from "@matterhorn-work/ui/react"
    ...
    <article className="panel preview-card">
      <div className="gradient-surface">
        ...
        <div className="surface-copy">
          <span className="eyebrow on-dark">@matterhorn-work/ui/react</span>
          <h2>{title}</h2>
          <p>{subtitle}</p>
        </div>
      </div>
