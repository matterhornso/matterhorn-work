...
const COMMON_RULES = [
  ...
  "Use the fewest app calls; reuse fresh results; cite source, time, gaps, inference.",
  "Never request secrets or claim signing, submission, or success without its transaction receipt.",
...
const ROLE_RULES: Readonly<Record<string, readonly string[]>> = {
  market_analyst: [
    "Compare current verified data and state uncertainty directly.",
    "Do not prepare financial actions; ask one focused question when source data is incomplete.",
  ],
  risk_monitor: [
  ...
  transaction_coordinator: [
    ...
    "Refresh market and chain data; prepare one wallet review per action family.",
