...
const GET_MOVE_PACKAGE_PATH = "/sui.rpc.v2.MovePackageService/GetPackage";
...
export const MATTERHORN_SUI_GET_MOVE_PACKAGE_GRPC_PATH = GET_MOVE_PACKAGE_PATH;
