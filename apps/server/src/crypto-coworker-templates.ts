...
const TEMPLATES: readonly MatterhornCoworkerTemplate[] = [
  ...
  },
  {
    ...
    suggestedPrompts: [
      ...
      "Prepare a Bittensor testnet stake and show me the validator, subnet, fees, slippage, and expiry before wallet review.",
  ...
  },
  {
    ...
    description: "Tracks approved balances and prepares exact Sui or Bittensor testnet transfers for wallet review.",
    suggestedPrompts: [
    ...
    profile: {
      name: "Treasury Coworker",
      role: "treasury_coworker",
      mission: "Maintain a concise view of approved testnet balances, decisions, and unresolved risks. Prepare exact Sui or Bittensor testnet transfers only from user-supplied terms and always stop at connected-wallet review.",
      allowedAppIds: ["matterhorn.sui-testnet", "matterhorn.hyperliquid-testnet", "matterhorn.bittensor-testnet"],
      allowedActionIds: [
        "sui_account_read",
        "sui_transfer_preview",
