...
describe("Recovery settings UI", () => {
  test("shows beta-unavailable diagnostics instead of dead destructive buttons", () => {
    ...
    expect(en).toContain('"settings.recovery_action_unavailable": "Unavailable in beta"');
