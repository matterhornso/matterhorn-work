...
export function SessionDebugPanel(props: {
  ...
  snapshot: MatterhornSessionSnapshot | null;
}) {
  return (
    <div className="fixed bottom-20 right-4 z-30 w-[280px] rounded-lg border border-dls-border bg-dls-surface/95 p-3 text-xs text-dls-secondary shadow-[var(--dls-card-shadow)] backdrop-blur-md">
