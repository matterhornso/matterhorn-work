...
export function resolveRenderedSessionSnapshot(input: {
  sessionId: string;
  currentSnapshot: MatterhornSessionSnapshot | null | undefined;
  cachedRendered: { sessionId: string; snapshot: MatterhornSessionSnapshot } | null | undefined;
}) {
...
export function deriveRenderedSessionMessages(input: {
  ...
  snapshot: MatterhornSessionSnapshot | null | undefined;
}) {
