...
export function WorkflowStageCard(props: WorkflowStageCardProps) {
  ...
  return (
    <div
      className={cn(
        "rounded-md bg-dls-surface/25 px-3.5 py-3 transition-colors hover:bg-dls-surface/40",
        isCurrent
    ...
    >
      ...
      {showDetails ? (
        <details className="group mt-2">
          <summary className="flex w-fit cursor-pointer list-none items-center gap-1.5 rounded-md px-0 py-1 text-[11px] font-medium leading-4 text-dls-secondary transition-colors hover:text-dls-text focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-dls-border">
            Details
          </summary>
