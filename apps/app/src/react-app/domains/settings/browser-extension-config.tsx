    ...
    <div className={`${surfaceCardClass} space-y-3 p-4`}>
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1 text-[13px] leading-relaxed text-dls-secondary">
          ...
          <div>The Matterhorn Desks Browser runs inside the app, opens visibly for browser tasks, and is the supported browser automation path in Matterhorn Desks.</div>
        </div>
      </div>
    </div>
  );
