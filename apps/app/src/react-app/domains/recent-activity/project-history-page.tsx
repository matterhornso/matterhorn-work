    ...
    >
      <div className="mx-auto w-full max-w-5xl space-y-5">
        ...
        {ledgerQuery.isLoading ? (
          <div className="flex items-center gap-2 py-3 text-xs text-dls-secondary">
          ...
          <div className="space-y-1">
            {latest ? (
              <div className="flex items-center justify-between gap-3 py-1 text-xs text-dls-secondary">
