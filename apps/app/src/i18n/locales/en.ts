...
export default {
  ...
  "settings.reset_matterhorn_desc_dev": "With dev mode active, it only clears the isolated engine dev state inside openwork-dev-data.",
  "settings.reset_matterhorn_desc_prod": "With dev mode active, it only clears the isolated engine dev state inside openwork-dev-data.",
