...
export default {
  ...
  "settings.deeplink_hint": "Accepts Matterhorn Work deep links.",
  ...
  "settings.environment.footer_hint": "MATTERHORN_WORK_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure engine runtime settings from your shell.",
  ...
  "settings.environment.validation_reserved": "MATTERHORN_WORK_ and OPENCODE_ names are managed by Matterhorn Work engine.",
