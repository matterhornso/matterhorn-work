...
export default {
  ...
  "composer.placeholder": "Ask Matterhorn about Bittensor, markets, wellness, files, or workflows...",
  ...
  "welcome.capability_files_desc": "Create wellness, customer, research, and operator workflow artifacts.",
