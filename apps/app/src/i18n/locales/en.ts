...
export default {
  ...
  "settings.environment.validation_reserved": "MATTERHORN_WORK_ and OPENCODE_ names are managed by Matterhorn Desks engine.",
  ...
  "system.reload_body_config": "The Matterhorn Desks engine reads opencode.json at startup. Reload the engine to apply configuration changes.",
  ...
  "system.reload_body_plugins": "The Matterhorn Desks engine loads npm plugins at startup. Reload the engine to apply opencode.json changes.",
