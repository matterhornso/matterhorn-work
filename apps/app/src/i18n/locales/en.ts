...
export default {
  ...
  "settings.api_keys_info": "API keys are stored locally by the underlying OpenCode runtime. Environment-backed providers must be changed in the worker environment and then reloaded.",
  ...
  "settings.auto_compact_desc": "Controls the underlying OpenCode compaction.auto setting for this workspace. Reload the engine after changing it.",
  ...
  "settings.custom_binary_hint": "Use this to point Matterhorn Work at a local OpenCode runtime build",
  ...
  "settings.environment.footer_hint": "MATTERHORN_WORK_, OPENWORK_, and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  ...
  "settings.environment.validation_reserved": "MATTERHORN_WORK_, OPENWORK_, and OPENCODE_ names are managed by Matterhorn/OpenCode.",
