...
export default {
  ...
  "settings.custom_binary_hint": "Use this to point Matterhorn at a local OpenCode build",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Matterhorn Work. Off by default.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Matterhorn Work.",
  ...
  "settings.matterhorn_config_sidecar_desc": "Local Matterhorn Work server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  ...
  "settings.reset_matterhorn_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside openwork-dev-data.",
  "settings.reset_matterhorn_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside openwork-dev-data.",
  "settings.reset_matterhorn_title": "Reset Matterhorn Work + OpenCode state",
  ...
  "system.reload_body_mixed": "Matterhorn Work detected OpenCode configuration changes. Reload the engine to apply them.",
