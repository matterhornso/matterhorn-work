...
export default {
  ...
  "extensions.subtitle": "Apps (MCP) and engine plugins live in one place.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Matterhorn Work can use them on your behalf.",
  "mcp.apps_title": "Apps",
