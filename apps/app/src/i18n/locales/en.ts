 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Matterhorn) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Matterhorn Work server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Matterhorn Work server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Matterhorn Work servers.",
  ...
  "config.server_needed_hint": "Matterhorn Work server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Matterhorn Work server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Matterhorn Work server",
  ...
  "config.server_sharing_title": "Matterhorn Work server sharing",
  "config.server_url_hint": "Use the URL shared by your Matterhorn Work server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Matterhorn Work server URL",
  "config.server_url_label": "Matterhorn Work Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Matterhorn Work server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Matterhorn Work server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Matterhorn Work server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Matterhorn Work server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Matterhorn Work server workspace is required to update authorized folders.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an Matterhorn Work server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Matterhorn Work server details for this workspace.",
  ...
  "den.cloud_workers_hint": "Open workers directly into Matterhorn Work using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_open_worker": "Failed to open {name} in Matterhorn Work.",
  ...
  "den.signin_link_hint": "Paste the sign-in link or one-time code only if the browser did not return to Matterhorn Work.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect Matterhorn Work.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Matterhorn Work.",
  ...
  "den.status_opened_worker": "Opened {name} in Matterhorn Work.",
  ...
  "extensions.plugins_opencode_header": "Plugins (engine runtime)",
  ...
  "identities.connect_server_title": "Connect to an Matterhorn Work server",
  ...
  "mcp.toggle_requires_server": "Connect to an Matterhorn Work server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect MCP servers, protocol tools, and agent capabilities that Matterhorn Work can use from chat.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Matterhorn Work.",
  ...
  "mcp.quick_connect_matterhorn_ui_desc": "Let agents see and drive the Matterhorn Work app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_matterhorn_ui_title": "Matterhorn Work UI Control",
  ...
  "notes.save_failed_description": "Matterhorn Work could not save this note.",
  ...
  "welcome.title": "Welcome to Matterhorn Work",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Matterhorn Work can pick them up.",
  "plugins.add": "Add",
  ...
  "plugins.desc": "Manage `opencode.json` for your project or global engine plugins.",
  ...
  "session.doom_loop_message": "The Matterhorn Work engine detected repeated tool calls with identical input and is asking whether it should continue after repeated failures.",
  ...
  "session.permission_message": "The Matterhorn Work engine is requesting permission to continue.",
  "session.permission_message_bash": "Review the command scope before allowing the Matterhorn Work engine to continue.",
  "session.permission_message_edit": "Review the file and diff before allowing the Matterhorn Work engine to make changes.",
  ...
  "settings.api_keys_info": "API keys are stored locally by the underlying Matterhorn Work engine runtime. Environment-backed providers must be changed in the worker environment and then reloaded.",
  ...
  "settings.auto_compact_desc": "Controls the underlying Matterhorn Work engine compaction.auto setting for this workspace. Reload the engine after changing it.",
  ...
  "settings.capabilities_title": "Matterhorn Work server capabilities",
  "settings.capabilities_unavailable": "Capabilities unavailable. Connect with a client token.",
  "settings.change": "Change",
  "settings.choose": "Choose",
  "settings.clear": "Clear",
  "settings.config_updated": "Configuration updated. Reload the engine if the change affects the Matterhorn Work engine.",
  ...
  "settings.custom_binary_hint": "Use this to point Matterhorn Work at a local Matterhorn Work engine build",
  ...
  "settings.debug_matterhorn_server_version": "Matterhorn Work server: {version}",
  ...
  "settings.deeplink_hint": "Accepts matterhorn-work:// links, with openwork:// links still supported.",
  ...
  "settings.enable_exa_desc": "Applies the next time the Matterhorn Work engine starts. Off by default.",
  ...
  "settings.engine_desc": "Choose how the Matterhorn Work engine runs locally.",
  ...
  "settings.exa_restart_hint": "Restart the Matterhorn Work engine after changing this setting.",
  ...
  "settings.opencode_engine_sidecar": "Matterhorn Work engine",
  ...
  "settings.matterhorn_config_sidecar_desc": "Local Matterhorn Work server (Bun) that hosts approvals, audit, and engine lifecycle.",
  "settings.matterhorn_diagnostics_title": "Matterhorn Work server diagnostics",
  "settings.matterhorn_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.matterhorn_server_label": "Matterhorn Work server",
  ...
  "settings.quit_hint": "Matterhorn Work quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Matterhorn Work server.",
  "settings.reconnected": "Reconnected to Matterhorn Work server.",
  ...
  "settings.reset_matterhorn_title": "Reset Matterhorn Work engine state",
  ...
  "settings.restart_matterhorn_server": "Restart Matterhorn Work server",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Matterhorn Work.",
  ...
  "settings.runtime_desc": "Status for your local engine and Matterhorn Work server.",
  ...
  "settings.environment.footer_hint": "MATTERHORN_WORK_, OPENWORK_, and OPENCODE_ keys are reserved for app/runtime wiring. Configure engine runtime settings from your shell.",
  ...
  "settings.environment.apply_confirm_body": "Matterhorn Work will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Matterhorn Work is not connected to a local workspace.",
  ...
  "settings.environment.validation_reserved": "MATTERHORN_WORK_, OPENWORK_, and OPENCODE_ names are managed by Matterhorn Work engine.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Matterhorn Work server.",
  ...
  "system.reload_body_agents": "The Matterhorn Work engine loads agents at startup. Reload the engine to make updated agents available.",
  "system.reload_body_commands": "The Matterhorn Work engine loads commands at startup. Reload the engine to make updated commands available.",
  "system.reload_body_config": "The Matterhorn Work engine reads opencode.json at startup. Reload the engine to apply configuration changes.",
  "system.reload_body_default": "Matterhorn Work detected changes that require reloading the engine instance.",
  "system.reload_body_mcp": "The Matterhorn Work engine loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Matterhorn Work detected engine configuration changes. Reload the engine to apply them.",
  "system.reload_body_plugins": "The Matterhorn Work engine loads npm plugins at startup. Reload the engine to apply opencode.json changes.",
  "system.reload_body_skills": "The Matterhorn Work engine can cache skill discovery/state. Reload the engine to make newly installed skills available.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Matterhorn Work can't load tasks from this worker until the connection is fixed.",
