 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, Matterhorn Desks engine, OpenPackage, Matterhorn) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Matterhorn Desks server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Matterhorn Desks server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "blueprint.empty_title": "Start a Matterhorn task",
  ...
  "blueprint.starter_hyperliquid_prompt": "Open the Hyperliquid desk and show me a safe read-only market context task.",
  "blueprint.starter_hyperliquid_title": "Use Hyperliquid desk",
  "blueprint.starter_polymarket_desc": "Research markets, check compliance, and prepare external-wallet handoffs.",
  "blueprint.starter_polymarket_prompt": "Open the Polymarket desk and help me research a market with compliance context.",
  "blueprint.starter_polymarket_title": "Use Polymarket desk",
  ...
  "blueprint.welcome_message": "Welcome to Matterhorn Desks.\n\nStart with a protocol desk, continue a chat, or collect project notes and outputs. Matterhorn keeps signing, custody, and live submission outside the app.\n\nWhat do you want to work on first?",
  "blueprint.welcome_title": "Welcome to Matterhorn Desks",
  "common.add": "Add",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Matterhorn Desks servers.",
  ...
  "config.server_needed_hint": "Matterhorn Desks server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to a Matterhorn Desks server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Matterhorn Desks server",
  ...
  "config.server_sharing_title": "Matterhorn Desks server sharing",
  "config.server_url_hint": "Use the URL shared by your Matterhorn Desks server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Matterhorn Desks server URL",
  "config.server_url_label": "Matterhorn Desks Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Matterhorn Desks server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Matterhorn Desks server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Matterhorn Desks server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Matterhorn Desks server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Matterhorn Desks server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_local_desc": "Create a project on this device.",
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Matterhorn worker using a URL and access token.",
  ...
  "dashboard.create_local_workspace_subtitle": "Create a project workspace on this device.",
  "dashboard.create_local_workspace_title": "Local project",
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Matterhorn worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save a Matterhorn Desks server as a workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Sign in to Matterhorn Cloud to access workers shared with your organization.",
  "dashboard.create_shared_title": "Shared workspaces",
  "dashboard.create_workspace_confirm": "Create Project",
  "dashboard.create_workspace_subtitle": "Create a project from a folder on this device.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Matterhorn Desks server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Matterhorn worker.",
  ...
  "den.auto_reconnect_hint": "If the browser does not return automatically, paste the one-time code here.",
  ...
  "den.cloud_provider_sync_detail": "Cloud provider changed. Sync the {count} model {source} configuration into this workspace.",
  "den.cloud_skill_detail": "Install this cloud skill for this workspace.",
  ...
  "den.cloud_providers_hint": "Import managed LLM providers and use the organization credential in this workspace.",
  "den.cloud_providers_title": "Cloud providers",
  "den.cloud_section_desc": "Sync work across devices and open shared workers when Cloud is configured.",
  "den.cloud_section_title": "Matterhorn Cloud",
  "den.cloud_sleep_hint": "Local workspaces keep working without an account. Sign in only when you want Cloud sync or shared workers.",
  "den.cloud_signed_in_desc": "Cloud sync is connected for this device.",
  "den.cloud_workers_hint": "Open workers directly into Matterhorn Desks using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Matterhorn Cloud did not return a session token.",
  "den.error_open_worker": "Failed to open {name} in Matterhorn Desks.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid Matterhorn sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Matterhorn Cloud sign-in.",
  ...
  "den.signin_code_note": "Accepts a matterhorn-work://den-auth link or the raw one-time grant.",
  "den.signin_link_hint": "Paste the sign-in link or one-time code only if the browser did not return to Matterhorn Desks.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "matterhorn-work://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Matterhorn Cloud",
  "den.signing_in": "Finishing Matterhorn Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.skill_hub_detail": "Import {count} shared skills into this workspace.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect Matterhorn Desks.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Matterhorn Desks.",
  "den.status_cloud_signed_in_as": "Connected Matterhorn Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Matterhorn Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in Matterhorn Desks.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your Matterhorn Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "extensions.apps_mcp_header": "MCP apps",
  ...
  "extensions.plugins_opencode_header": "Advanced plugins",
  "extensions.subtitle": "MCP servers, app connectors, and engine plugins live in one place.",
  "extensions.title": "MCPs & Tools",
  "identities.agent_behavior_desc": "One file per workspace. Add optional first line @agent <id> to route via a specific engine agent.",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an Matterhorn host.",
  "identities.connect_server_title": "Connect to a Matterhorn Desks server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check Matterhorn URL/token and try again.",
  ...
  "mcp.toggle_requires_server": "Connect to a Matterhorn Desks server to enable or disable MCPs.",
  "mcp.add_modal_subtitle": "Connect a custom MCP server by URL or local command.",
  "mcp.add_modal_title": "Add Custom MCP",
  "mcp.add_server_button": "Add MCP",
  ...
  "mcp.app_connected": "MCP server active",
  "mcp.apps_connected": "MCP servers active",
  "mcp.apps_subtitle": "Connect MCP servers, protocol tools, and agent capabilities that Matterhorn Desks can use from chat.",
  "mcp.apps_title": "MCPs & Connectors",
  ...
  "mcp.auth.oauth_not_supported_hint": "This could mean:\n• The MCP server does not advertise OAuth capabilities\n• The engine needs to reload to discover server capabilities\n• Run the MCP authorization command from the machine running Matterhorn Desks",
  ...
  "mcp.auth.reauth_cli_hint": "Run the MCP authorization command from the machine running Matterhorn Desks.",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Matterhorn needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Matterhorn needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Matterhorn",
  ...
  "mcp.available_apps": "Available MCPs & connectors",
  ...
  "mcp.custom_app_cta_hint": "Connect your own MCP server, internal tool, or hosted connector.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Matterhorn Desks.",
  ...
  "mcp.one_click_connect": "Safe connect",
  ...
  "mcp.quick_connect_matterhorn_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_matterhorn_cloud_title": "Matterhorn Cloud Control",
  "mcp.quick_connect_matterhorn_ui_desc": "Let agents see and drive the Matterhorn Desks app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_matterhorn_ui_title": "Matterhorn Desks UI Control",
  ...
  "mcp.tap_to_connect": "Review and connect",
  ...
  "notes.attachment_remove": "Remove attachment",
  "notes.attachment_type_attached": "Attached",
  "notes.attachment_type_desk": "Desk",
  "notes.attachment_type_output": "Output",
  "notes.attachment_type_session": "Session",
  "notes.attachment_type_task": "Task",
  "notes.cancel": "Cancel",
  "notes.cmd_notes_detail": "Open project notes",
  "notes.cmd_notes_meta": "Notes",
  "notes.cmd_notes_title": "Notes",
  "notes.cmd_quick_jot_detail": "Jot a note without leaving the current view",
  "notes.cmd_quick_jot_meta": "Notes",
  "notes.cmd_quick_jot_title": "Quick Jot",
  "notes.create_first_note": "Create first note",
  "notes.create_note": "New note",
  "notes.delete_note": "Delete note",
  "notes.empty_default_description": "Jot thoughts, attach context, and suggest the ones worth remembering.",
  "notes.empty_default_title": "No notes yet",
  "notes.empty_no_matches_description": "Try a different search or filter.",
  "notes.empty_no_matches_title": "No matches",
  "notes.empty_no_notes_description": "Create a note or use Quick Jot from anywhere in the app.",
  "notes.empty_no_notes_title": "No notes yet",
  "notes.empty_no_project_description": "Notes are saved per project. Create or select a workspace from the sidebar first.",
  "notes.empty_no_project_title": "Open a project to see notes",
  "notes.empty_select_description": "Choose a note from the list to view or edit it.",
  "notes.empty_select_title": "Select a note",
  "notes.filter_all": "All notes",
  "notes.filter_bittensor": "Bittensor",
  "notes.filter_hyperliquid": "Hyperliquid",
  "notes.filter_longevity": "Longevity",
  ...
  "notes.memory_sent_description": "Sent to Memory inbox for review. It is not remembered yet.",
  "notes.memory_suggested_badge": "Memory suggested",
  "notes.no_project_selected_description": "Open or create a project before adding notes.",
  "notes.open_notes": "Open notes",
  "notes.settings_description": "Project notes you control. Nothing is remembered unless you suggest it.",
  "notes.settings_title": "Notes",
  "notes.no_project_selected_title": "No project selected",
  "notes.note_title_placeholder": "Note title",
  "notes.page_description": "Project notes you control. Nothing is remembered unless you suggest it.",
  "notes.page_title": "Notes",
  "notes.quick_jot_description": "Jot a project note. Nothing is remembered unless you choose to suggest it.",
  "notes.quick_jot_save": "Save note",
  "notes.quick_jot_save_and_suggest": "Save & suggest memory",
  "notes.quick_jot_saving": "Saving…",
  "notes.quick_jot_title": "Quick Jot",
  "notes.quick_jot_button_title": "Jot a note",
  "notes.jot_action": "Jot",
  "notes.rail_label": "Notes",
  "notes.rail_title": "Project notes",
  "notes.save_failed": "Could not save note",
  "notes.save_failed_description": "Matterhorn Desks could not save this note.",
  "notes.search_placeholder": "Search notes…",
  "notes.send_memory_failed_title": "Could not suggest memory",
  "notes.send_memory_skipped_title": "Note saved, Memory skipped",
  "notes.send_memory_success_title": "Sent to Memory inbox",
  "notes.server_not_connected": "Matterhorn server is not connected.",
  "notes.suggest_memory": "Suggest memory",
  "notes.tags_label": "Tags",
  "notes.tags_placeholder": "Add tags, separated by commas",
  "notes.toast_note_saved_description": "Your note is stored in this project.",
  "notes.toast_note_saved_title": "Note saved",
  "notes.toast_send_memory_fallback_description": "Sending to Memory inbox from the active workspace session if available.",
  "notes.untitled": "Untitled note",
  "notes.write_placeholder": "Write your note…",
  ...
  "welcome.title": "Welcome to Matterhorn Desks",
  "welcome.subtitle": "Use Bittensor, Hyperliquid, Polymarket, and real-world workflows through one safe chat workspace.",
  "welcome.get_started": "Create your first workspace",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Matterhorn will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Matterhorn Desks can pick them up.",
  "plugins.add": "Add",
  "plugins.add_hint": "Add an npm package name for an approved workspace plugin.",
  "plugins.add_label": "Add plugin",
  "plugins.added": "Added",
  "plugins.config": "Config",
  "plugins.config_label": "Config",
  "plugins.desc": "Manage approved workspace and local engine plugins.",
  ...
  "session.cmd_new_session_workspace_required_detail": "Create or connect a workspace before starting a chat",
  "session.cmd_new_session_workspace_required_meta": "Workspace required",
  ...
  "session.doom_loop_message": "The Matterhorn Desks engine detected repeated tool calls with identical input and is asking whether it should continue after repeated failures.",
  ...
  "session.permission_message": "The Matterhorn Desks engine is requesting permission to continue.",
  "session.permission_message_bash": "Review the command scope before allowing the Matterhorn Desks engine to continue.",
  "session.permission_message_edit": "Review the file and diff before allowing the Matterhorn Desks engine to make changes.",
  ...
  "session.rename_description": "Update the name shown for this chat.",
  ...
  "session.select_or_create_session": "Open Home or choose a Matterhorn desk to start.",
  ...
  "session.share_local_host_not_ready": "Local Matterhorn host is not ready yet.",
  "session.share_missing_host_url": "Missing Matterhorn host URL.",
  "session.share_missing_token": "Missing Matterhorn token.",
  ...
  "session.share_opencode_base_url": "Engine base URL",
  "session.share_matterhorn_workers_only": "Share service links are available for Matterhorn workers.",
  ...
  "settings.api_keys_info": "API keys are stored locally by the underlying Matterhorn Desks engine runtime. Environment-backed providers must be changed in the worker environment and then reloaded.",
  ...
  "settings.auto_compact_desc": "Controls the underlying Matterhorn Desks engine compaction.auto setting for this workspace. Reload the engine after changing it.",
  ...
  "settings.capabilities_title": "Matterhorn Desks server capabilities",
  "settings.capabilities_unavailable": "Capabilities unavailable. Connect with a client token.",
  "settings.change": "Change",
  "settings.choose": "Choose",
  "settings.clear": "Clear",
  "settings.config_updated": "Configuration updated. Reload the engine if the change affects the Matterhorn Desks engine.",
  ...
  "settings.custom_binary_hint": "Use this to point Matterhorn Desks at a local Matterhorn Desks engine build",
  ...
  "settings.debug_matterhorn_server_version": "Matterhorn Desks server: {version}",
  ...
  "settings.deeplink_hint": "Accepts Matterhorn Desks deep links.",
  ...
  "settings.enable_exa": "Enable Parallel Web Systems web search",
  "settings.enable_exa_desc": "Applies the next time the Matterhorn Desks engine starts. Off by default.",
  "settings.exa_unavailable": "Parallel Web Systems web search is not yet configurable in this settings view.",
  ...
  "settings.engine_desc": "Choose how the Matterhorn Desks engine runs locally.",
  ...
  "settings.exa_restart_hint": "Restart the Matterhorn Desks engine after changing this setting.",
  ...
  "settings.feedback_title": "Help shape Matterhorn",
  ...
  "settings.open_deeplink_desc": "Paste an Matterhorn deeplink or share URL to open it.",
  ...
  "settings.opencode_engine_sidecar": "Matterhorn Desks engine",
  ...
  "settings.matterhorn_config_sidecar_desc": "Local Matterhorn Desks server (Bun) that hosts approvals, audit, and engine lifecycle.",
  "settings.matterhorn_diagnostics_title": "Matterhorn Desks server diagnostics",
  "settings.matterhorn_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.matterhorn_server_label": "Matterhorn Desks server",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Matterhorn cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Matterhorn cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Matterhorn will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Matterhorn preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Matterhorn local preferences and workspace onboarding markers.",
  "settings.reset_matterhorn_desc_dev": "With dev mode active, it only clears isolated developer runtime data.",
  "settings.reset_matterhorn_desc_prod": "With dev mode active, it only clears isolated developer runtime data.",
  "settings.reset_matterhorn_title": "Reset Matterhorn Desks engine state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Matterhorn will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart engine",
  "settings.restart_matterhorn_server": "Restart Matterhorn Desks server",
  ...
  "settings.services_section_desc": "Engine and server processes for this Matterhorn session. Each process has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Matterhorn Desks.",
  ...
  "settings.recovery_action_unavailable": "Not available in this release",
  ...
  "settings.runtime_desc": "Status for your local engine and Matterhorn Desks server.",
  ...
  "settings.tab_cloud_workers": "Cloud Workers Preview",
  ...
  "settings.tab_description_appearance": "Adjust how Matterhorn looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_cloud_workers": "Preview cloud-hosted worker instances. Requires Matterhorn Cloud sign-in.",
  "settings.tab_description_debug": "Review runtime diagnostics, logs, and low-level debugging utilities.",
  "settings.tab_description_extensions": "Manage MCP apps and engine plugins for this workspace.",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Matterhorn workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "Reserved Matterhorn runtime keys are managed automatically. Configure local engine settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before Matterhorn starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Matterhorn Desks will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Matterhorn Desks is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Matterhorn status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "This name is reserved by Matterhorn Desks.",
  ...
  "settings.tab_extensions": "MCPs & Tools",
  ...
  "settings.updates_desc": "Keep Matterhorn up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an Matterhorn host, then choose it from the list to import this skill.",
  ...
  "skills.add_matterhorn_hub": "Add Matterhorn Hub",
  ...
  "skills.cloud_org_fallback": "Matterhorn Cloud",
  "skills.cloud_org_load_failed": "Failed to load organization skills.",
  "skills.cloud_refresh": "Refresh team skills",
  "skills.cloud_section_subtitle": "Skills shared with you through Matterhorn Cloud — including team skill hubs you can access.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to Matterhorn Cloud to browse team and org skills.",
  ...
  "skills.failed_load_opencode": "Failed to load workspace configuration",
  "skills.failed_parse_opencode": "Failed to read workspace configuration",
  "skills.failed_to_load": "Failed to load skills",
  "skills.failed_update_opencode": "Failed to update workspace configuration",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Matterhorn Desks server.",
  ...
  "skills.no_opencode_found": "No workspace configuration yet. Add a plugin to create one.",
  "skills.no_opencode_workspace": "No workspace configuration here yet.",
  "skills.no_skills": "No skills were detected in this workspace or your connected skill folders.",
  ...
  "skills.plugin_already_listed": "Plugin already listed in workspace configuration.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Matterhorn Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Matterhorn Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Matterhorn Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Matterhorn features",
  ...
  "status.matterhorn_ready": "Matterhorn Desks Ready",
  "status.providers_connected_one": "{count} provider connected",
  "status.providers_connected_other": "{count} providers connected",
  "status.ready_for_tasks": "Ready",
  "status.running": "Running",
  "status.send_feedback": "Send feedback",
  "status.settings": "Settings",
  "system.reload_body_agents": "The Matterhorn Desks engine loads agents at startup. Reload the engine to make updated agents available.",
  "system.reload_body_commands": "The Matterhorn Desks engine loads commands at startup. Reload the engine to make updated commands available.",
  "system.reload_body_config": "The Matterhorn Desks engine reads workspace configuration at startup. Reload the engine to apply configuration changes.",
  "system.reload_body_default": "Matterhorn Desks detected changes that require reloading the engine instance.",
  "system.reload_body_mcp": "The Matterhorn Desks engine loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Matterhorn Desks detected engine configuration changes. Reload the engine to apply them.",
  "system.reload_body_plugins": "The Matterhorn Desks engine loads installed npm plugins at startup. Reload the engine to apply configuration changes.",
  "system.reload_body_skills": "The Matterhorn Desks engine can cache skill discovery/state. Reload the engine to make newly installed skills available.",
  ...
  "workspace.create_workspace": "Create project",
  "workspace.empty_state_body": "Create or connect a project workspace to get started.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Matterhorn Desks can't load tasks from this worker until the connection is fixed.",
  ...
  "workspace_list.show_more_fallback": "Show more chats",
