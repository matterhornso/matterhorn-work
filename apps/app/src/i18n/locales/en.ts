...
export default {
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Matterhorn Work will reconnect here automatically.",
  ...
  "den.cloud_sleep_hint": "Sign in to Matterhorn Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Matterhorn Cloud.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into Matterhorn Work automatically, paste the sign-in link or one-time code from Matterhorn Cloud here.",
  ...
  "notes.tags_placeholder": "comma, separated",
  ...
  "settings.services_section_desc": "Local services that power this Matterhorn session. Each service has its own restart and logs.",
