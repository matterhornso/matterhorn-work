...
export function CommandDialogBackdrop({
  ...
  return (
    <CommandDialogPrimitive.Backdrop
      className={cn(
        "fixed inset-0 z-50 bg-black/25 transition-all duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
...
export function CommandFooter({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between gap-2 rounded-b-lg border-t border-foreground/10 dark:border-border px-5 py-3 text-muted-foreground text-xs",
        className,
      )}
