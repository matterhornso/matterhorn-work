...
const cardVariants = cva(
  "group/card flex flex-col overflow-hidden rounded-lg text-sm text-card-foreground has-[>img:first-child]:pt-0 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg",
  {
    variants: {
      variant: {
        default: "border border-border/45 bg-card shadow-[var(--dls-card-shadow)] transition-[background-color,box-shadow,transform] duration-150 ease-out motion-reduce:transition-none",
