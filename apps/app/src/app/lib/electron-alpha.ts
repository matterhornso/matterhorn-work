...
const ELECTRON_ALPHA_RELEASE_BASE_URL =
  "https://github.com/matterhornso/matterhorn-work/releases/download/alpha-macos-latest";

export const ELECTRON_ALPHA_RELEASE_PAGE_URL =
  "https://github.com/matterhornso/matterhorn-work/releases/tag/alpha-macos-latest";
