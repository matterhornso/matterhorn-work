...
| Market official SDK evidence | No server route; operator-owned testnet/fixture artifacts only | No MCP tool; agents use the documented operator loop and public evidence bundle | `matterhorn-work crypto sdk-loop` for the copy-pasteable loop; `matterhorn-work crypto evidence-bundle` for the final customer bundle; raw helpers remain available: `node scripts/market-official-sdk-validation-doctor.mjs`, `node scripts/market-official-sdk-normalize.mjs`, `node scripts/market-official-sdk-validation-capture.mjs`, `node scripts/market-official-sdk-operator-loop.mjs` | `test:market-official-sdk-validation-doctor`, `test:market-official-sdk-normalize`, `test:market-official-sdk-operator-loop`, `test:market-official-sdk-validation-capture`, `test:market-official-sdk-validation-track`, `test:market-customer-evidence-bundle`, `test:crypto-cli-fallback` |
