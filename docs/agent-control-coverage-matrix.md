...
| Market execution chain gate | Aggregate no-submit contract over preview/handoff, explicit testnet external sign-request, public/redacted artifact validation, artifact reconciliation, and public receipt import; every step remains hash-bound and customer-safe | MCP coverage spans `matterhorn_hyperliquid_create_sign_request`, `matterhorn_polymarket_create_sign_request`, `matterhorn_hyperliquid_validate_external_artifact`, `matterhorn_polymarket_validate_external_artifact`, `matterhorn_market_artifact_reconcile`, and venue receipt tools | `matterhorn-work crypto execution-chain` prints the local safe command plan; Demo tab and CLI expose copy-only venue commands: `matterhorn-work hyperliquid sign-request`, `matterhorn-work polymarket sign-request`, `matterhorn-work hyperliquid validate-artifact`, `matterhorn-work polymarket validate-artifact`, and venue receipt commands; no submit command exists | `market.execution_chain_gate`, `test:market-execution-chain-gate`, `test:crypto-cli-fallback`, `test:customer-readiness-ui`, `test:market-sign-request-phase1`, `test:market-artifact-validation-phase2`, `test:market-artifact-reconciliation`, `test:market-receipt-qa`, `test:market-execution-safety-gate` |
