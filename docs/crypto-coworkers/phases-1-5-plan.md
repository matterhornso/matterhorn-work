...
- Current Phase 4 slice: automatic finalized-run sealing, renewal, Quilt batching, and the simplified account UI remain pending. Testnet publication stays server-owned and configuration-gated; mainnet remains disabled.
