...
- Current Phase 4 slice: automatic finalized-run sealing, renewal, Quilt batching, and simplified publication/recovery controls remain pending. Testnet publication stays server-owned and configuration-gated; mainnet remains disabled.
