...
- Current slice: add protocol-aware refresh immediately before wallet review and persist pending-intent lifecycle state. Scheduled checks remain read-only and cannot prepare, sign, relay, broadcast, or submit.
