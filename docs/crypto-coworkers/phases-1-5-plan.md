...
- Current slice: connect the transaction coordinator to account-safe wallet-review routes and reconcile connected-wallet public receipts without creating an agent-facing submission route.
