...
- Current Phase 2 slice: add chat-first Market Analyst and Risk Monitor templates, structured working state, and a capability/run binding so lifecycle invalidation closes every coworker-owned run.
