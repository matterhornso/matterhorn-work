...
- Current slice: begin Phase 3 with the deterministic transaction coordinator and reviewed-action v2 regeneration path. Scheduled checks remain read-only and cannot prepare, sign, relay, broadcast, or submit.
