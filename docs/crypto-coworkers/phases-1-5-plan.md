...
- Current Phase 2 slice: persist explicit schedules/watches and an alert inbox, then connect chat-created read/watch tasks to the certified gateway without adding autonomous wallet authority.
