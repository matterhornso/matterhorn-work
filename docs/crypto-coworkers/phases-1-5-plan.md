...
- Current Phase 2 slice: persist structured coworker working state and explicit schedules/watches, then connect chat-created read/watch tasks to the certified gateway without adding autonomous wallet authority.
