...
| Mutable OpenAPI operation document | No OpenAPI runtime executor until exact path and method are signed in a versioned manifest | Changed API descriptions cannot redirect an approved action to a different route |
