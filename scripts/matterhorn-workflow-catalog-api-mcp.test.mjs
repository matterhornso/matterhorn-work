...
assert.match(serverSource, /GET", "\/api\/workflows\/templates"/);
...
assert.match(serverSource, /buildMatterhornCustomerWorkflowTemplates/);
...
assert.match(workflowToolSource, /version: "matterhorn\.customer\.workflow\.template\.v1"/);
assert.match(workflowToolSource, /recommendedSurface: "protocol_desk"/);
assert.match(workflowToolSource, /defaultPrompt: "Show my TAO"/);
assert.match(workflowToolSource, /iconHint: "bittensor"/);
assert.match(workflowToolSource, /chatMode: "hyperliquid"/);
assert.match(workflowToolSource, /startsSession: true/);
...
assert.match(workflowToolSource, /hyperliquid_trader/);
assert.match(workflowToolSource, /polymarket_researcher/);
assert.match(workflowToolSource, /blank_chat_workflow/);
...
assert.match(coverageMatrix, /matterhorn_workflows_customer_templates/);
assert.match(coverageMatrix, /matterhorn-work workflows templates --customer-template bittensor_operator --json/);
