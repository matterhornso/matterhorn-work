...
for (const phrase of [
  ...
  "Matterhorn Desks",
  "Separate interfaces for TAO, perps, prediction markets, and real-world workflows",
  "focused desk",
  "No hidden auto-send",
  "Business workflows",
  "Use the same chat engine for real-world customer work",
  "Wellness is a standalone business workflow, not Web3, not markets, and not medical care.",
  "Monday beta demos",
  ...
  "Plan trainer, yoga, or dietician service workflows without Web3, markets, or medical advice.",
  "Can submit: No",
  "Live submission: Off",
