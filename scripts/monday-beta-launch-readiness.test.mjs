...
for (const check of [
  ...
  "Hyperliquid agent is prepare_only",
  "Hyperliquid agent, automation, and agent signing stay disabled",
  "Hyperliquid completion requires the reviewed user surface",
  "Polymarket scenario canSubmit is false",
  "Polymarket protocol workspace is beta_ready",
  "Polymarket agent is prepare_only",
  "Polymarket agent, automation, and agent signing stay disabled",
  "Polymarket completion requires the reviewed user surface",
