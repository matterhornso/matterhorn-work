...
const STAGES = [
  ...
  },
  {
    id: "desk.depth",
    label: "Desk depth",
    summary: "Bittensor, Hyperliquid, Polymarket, Sui, Longevity, and the complete offline crypto acceptance matrix.",
    themes: [
    ...
    command: [
      ...
      "&&",
      "node",
      "scripts/customer-ready-crypto-smoke.mjs",
      "--offline",
      "--strict",
      "&&",
      "node",
      "scripts/crypto-tool-authority-gate.mjs",
      "&&",
      "node",
  ...
  },
  {
    ...
    command: [
      ...
      "&&",
      "pnpm",
      "test:hosted-mcp-access-acceptance",
      "&&",
      "node",
  ...
  },
  {
    ...
    summary: "Production environment, container, launch-channel, surface-registry, CORS, and product-readiness contracts.",
    themes: [
    ...
    command: [
      ...
      "&&",
      "node",
      "scripts/public-beta-web-readiness.test.mjs",
      "&&",
      "node",
      "scripts/product-hunt-deployment-probe.test.mjs",
      "&&",
      "node",
      "scripts/monday-beta-launch-readiness.test.mjs",
      "&&",
      "node",
      "scripts/launch-channel-readiness.test.mjs",
      "&&",
      "node",
      "scripts/public-beta-container-contract.test.mjs",
      "&&",
      "node",
      "scripts/surface-readiness-contract.test.mjs",
      "&&",
      "node",
      "scripts/wallet-profile-mcp-readiness-contract.test.mjs",
      "&&",
      "node",
      "scripts/product-hunt-launch-kit.test.mjs",
      "&&",
      "node",
      ...
      "&&",
      "pnpm",
      "test:crypto-app-sdk-publish-workflow",
      "&&",
      "pnpm",
      ...
      "&&",
      "node",
      "scripts/matterhorn-host-recovery.test.mjs",
      "&&",
      "node",
      "--test",
      "scripts/verified-host-backup-upload.test.mjs",
      "&&",
      "node",
      "scripts/bittensor-wallet-timeline-legacy-archive.test.mjs",
      "&&",
      "node",
      "scripts/product-hunt-operations-evidence.test.mjs",
      "&&",
      "node",
      "scripts/public-beta-rollback-hook.test.mjs",
      "&&",
      "node",
      "scripts/product-hunt-rollback-rehearsal.test.mjs",
      "&&",
      "node",
      "scripts/guarded-runtime-shadow-evidence.test.mjs",
      "&&",
      "node",
      "scripts/guarded-runtime-token-acceptance.test.mjs",
      "&&",
      "node",
      "scripts/product-hunt-acceptance-evidence.test.mjs",
      "&&",
      "node",
      "scripts/crypto-coworkers-acceptance-evidence.test.mjs",
      "&&",
      "pnpm",
      "test:venice-private-acceptance",
      "&&",
      "pnpm",
      "test:crypto-coworkers-acceptance-report",
      "&&",
      "node",
      "scripts/crypto-coworker-reference-patterns.test.mjs",
      "&&",
      "node",
