...
assertIncludes(sessionRoute, "useSessionAgentState(", "session route chat-scoped agent selection");
assertIncludes(sessionRoute, "setSelectedAgent(agent)", "session route launcher agent selection");
