...
tools:
  ...
  "matterhorn-work_matterhorn_bittensor_prepare_action": true
...
Runtime tools are deny-by-default. In Work mode, only 3 explicitly listed desk tools are available.
